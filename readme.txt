...
<strong>Warning: The plugin is being discontinued, but you can use the <a href="http://wordpress.org/plugins/simple-responsive-slider/">Simple Responsive Slider</a></strong><br /><br />
