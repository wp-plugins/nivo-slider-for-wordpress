	...
	function nivoslider4wp_install() {
		...
		if (function_exists('add_contextual_help')) {
			add_contextual_help( $plugin_options ,'<h2 style="font-weight:lighter;">'. __('Nivo Slider for WordPress - Help > Options', 'nivoslider4wp') .'</h2>'.
				...
				'<em style="color:red;">'. __('Important: if you change these dimensions after you have already inserted some image, will have to crop the images again, so that they fit the dimensions defined.', 'nivoslider4wp') .'</em>' .
